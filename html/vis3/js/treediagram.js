...
TreeDiagram.prototype.updateVis = function(source) {
    ...
    var node = vis.chart.selectAll("g.node")
        .data(vis.nodes, function(d) { return d.nid || (d.nid = ++vis.i); });
    ...
    nodeEnter.append("text")
        .attr("x", function(d) { return d.children || d._children ? (-10 - d.radius ) : (10 + d.radius); })
        .attr("dy", ".35em")
        .attr("text-anchor", function(d) { return d.children || d._children ? "end" : "start"; })
        .text(function(d) { return d.key ? d.key : (d.model + " - " + d.model_year) ; })
    ...
    var link = vis.chart.selectAll("path.link")
        .data(vis.links, function(d) { return d.target.nid; });
